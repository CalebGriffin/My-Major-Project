...
Shader "Polytope Studio/ PT_Medieval Armors Shader PBR"
{
	Properties
	{
		...
		_HAIRCOLOR("HAIR COLOR", Color) = (0.5943396,0.3518379,0.1093361,0)
		...
		_SCARSCOLOR("SCARS COLOR", Color) = (0.8490566,0.5037117,0.3884835,0)
		_SCARSSMOOTHNESS("SCARS SMOOTHNESS", Range( 0 , 1)) = 0.3
		_METAL1COLOR("METAL 1 COLOR", Color) = (2,0.682353,0.1960784,0)
		...
		_CLOTH1COLOR("CLOTH 1 COLOR", Color) = (0.1465379,0.282117,0.3490566,0)
		_CLOTH2COLOR("CLOTH 2 COLOR", Color) = (1,0,0,0)
		_CLOTH3COLOR("CLOTH 3 COLOR", Color) = (0.8773585,0.6337318,0.3434941,0)
		_GEMS1COLOR("GEMS 1 COLOR", Color) = (0.3773585,0,0.06650025,0)
		_GEMS1SMOOTHNESS("GEMS 1 SMOOTHNESS", Range( 0 , 1)) = 1
		_GEMS2COLOR("GEMS 2 COLOR", Color) = (0.2023368,0,0.4339623,0)
		_GEMS2SMOOTHNESS("GEMS 2 SMOOTHNESS", Range( 0 , 1)) = 0
		_GEMS3COLOR("GEMS 3 COLOR", Color) = (0,0.1132075,0.01206957,0)
		...
		_FEATHERS3COLOR("FEATHERS 3 COLOR", Color) = (0,0.1793142,0.7264151,0)
