       ...
       // public RandomPrefabPlacer placer = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (selectedItem != -1)
            {
                ...
                brush.prefabs[selectedItem].scaleMin = EditorGUILayout.FloatField(brush.prefabs[selectedItem].scaleMin);
                brush.prefabs[selectedItem].scaleMax = EditorGUILayout.FloatField(brush.prefabs[selectedItem].scaleMax);
